...
function Map(props: MapProps) {
  ...
  return <div
    ...
    style={{ width, height, overflow: fullScreen ? 'hidden' : 'visible', backgroundColor: '#dcdcdc' }}
  ...
  >
    ...
    {/* CLUSTER LABELS */}
    {
      fullScreen && showLabels && !zoom.dragging && <div>{clusters.map((cluster) =>
        <div className='absolute opacity-90 bg-white p-2 max-w-lg rounded-lg pointer-events-none select-none transition-opacity duration-300 font-bold'
